...
| UI 组件 | Tailwind CSS + shadcn/ui + Lucide icons | 稳定成熟的 React 组件体系 |
| 数据可视化 | Recharts | 开发效率高，满足 Elo 曲线/评估值图表需求 |

## 视觉设计

**美学方向：Paper / 纸张文具风**

整体追求"老茶馆下棋"的氛围——宣纸质感、毛笔字韵味、微微泛黄的温暖底色。
...
**字体：**
- 棋子/标题：Ma Shan Zheng（毛笔行书）→ Noto Serif SC fallback
- 正文/UI：Noto Serif SC（宋体）
...
- 楚河汉界用传统书法字
- 大量留白，排版疏朗
- 排行榜用"一、二、三"等中文数字标序（可选）
- 动效克制：走子平滑移动、吃子淡出，不用花哨特效
